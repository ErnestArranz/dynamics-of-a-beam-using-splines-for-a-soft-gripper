...
ku2 = ku^2;
%%
kugrad = simplify(gradient(ku2, [x_1 x_2 y_2 x_3 y_3]));
%%
%dpu/du
moddpu_du = simplify(sqrt(pux_dot^2 + puy_dot^2));

srtermsimp = simplify(gradient((1- moddpu_du)^2, [x_1 x_2 y_2 x_3 y_3]));

srternosimp = simplify(gradient(((1- moddpu_du)^2)*moddpu_du, [x_1 x_2 y_2 x_3 y_3]));